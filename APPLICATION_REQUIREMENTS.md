...
| FR-XP-074 | Runecraft shall provide a selectable 138,000 XP/hour 1+1 dolo Aether route from level 90. It shall model 63 essence from the crafting account and 46 tradeable pure essence from a level-75 runner using an underfilled colossal pouch and two equal trades, for 109 essence and 2,180 XP across five per-craft batches per lap. Economics shall price both accounts' ring charges, two Magic Imbue casts, one binding necklace per three-lap disposal cycle, the crafting account's pre-99 pouch repairs, and per-craft rounded output and catalyst consumption. It shall exclude Daeyalt essence because it cannot be traded and disclose the runner's redwood-lit Abyssal lantern assumption. |
