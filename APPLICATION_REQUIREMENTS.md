...
| FR-XP-065 | An editable personal XP/hour value shall represent the player's base rate. Rate-affecting skill configurations shall apply their documented multipliers on top of that value for eligible bands only, including Daeyalt essence, Pyromancer's outfit, Carpenter's outfit, and Smiths' uniform. Finite configuration resources shall stop contributing their multiplier when exhausted, while method/action-rate choices and economics-only configurations shall not be double-applied. |
