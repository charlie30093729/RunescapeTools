...
| FR-XP-068 | Woodcutting shall provide selectable regular-crystal-axe redwood and ironwood routes at their level 90 and level 80 unlocks. Redwood shall scale from 70,000 to 75,000 XP/hour and ironwood from approximately 75,000 to 95,000 XP/hour by level 99, based on the documented dragon-axe range and the crystal axe's 4.5% relative advantage. Both routes shall bank and value one log per successful chop, price one crystal-axe charge per log through whole enhanced crystal teleport seeds, and exclude felling-axe XP and Forester's rations. |
