...
public sealed class CatalogueConfigurationTests
{
    ...
    public void ExpectedSkillsExposeConfigurators()
    {
        ...
        Assert.That(string.Join('|', configuredSkills), Is.EqualTo("Prayer|Fletching|Firemaking|Smithing|Herblore|Farming|Runecraft|Construction|Sailing"), "requested skill configurators");
